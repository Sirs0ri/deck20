(() => {
  ...
  var log = (...args) => console.log("[bex] dom", ...args);
  async function getChat() {
    const playerPromise = new Promise((resolve) => {
      const interval = setInterval(() => {
        var _a, _b, _c;
        const isLoaded = ((_c = (_b = (_a = window.currentPlayer) == null ? void 0 : _a.d20) == null ? void 0 : _b.textchat) == null ? void 0 : _c.chatstartingup) === false;
        if (isLoaded) {
  ...
  var dom_default = (0, import_wrappers.bexDom)(async (bridge2) => {
    ...
    bridge2.on("forwarded-comm", async ({ data, respond }) => {
