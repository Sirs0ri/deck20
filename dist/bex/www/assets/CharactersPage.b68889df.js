...
import { a as QSpinner, Q as QBtn } from "./QBtn.5848d314.js";
import { w as watch, o as onMounted, a as onBeforeUnmount, z as inject, af as formKey, g as getCurrentInstance, r as ref, q as computed, t as debounce, ag as injectProp, ah as onBeforeUpdate, m as stopAndPrevent, b as nextTick, u as onDeactivated, v as onActivated, i as isRuntimeSsrPreHydration, h, f as prevent, H as getUid, $ as Transition, F as shouldIgnoreKey, c as client, s as stop, E as isKeyCode, j as position, ai as toRaw, n as noop, aj as fabKey, B as provide, a6 as storeToRefs, I as reactive, K as openBlock, L as createBlock, M as withCtx, N as createVNode, _ as createTextVNode, O as createBaseVNode, R as unref, Z as toDisplayString, a8 as createCommentVNode, ak as TransitionGroup, a7 as normalizeStyle, U as normalizeClass, P as createElementBlock, Q as renderList, S as Fragment, al as withKeys, x as withDirectives, aa as withModifiers, am as isRef } from "./index.b0068bd8.js";
import { Q as QIcon, b as useSize, a as useSizeProps } from "./QIcon.b3f3bd12.js";
import { u as useDarkProps, a as useDark } from "./use-dark.73118c32.js";
import { b as hSlot, c as createComponent, h as hMergeSlot } from "./render.a8eadc37.js";
import { k as addFocusFn, l as removeFocusFn, u as useAnchorProps, a as useModelToggleProps, b as useTransitionProps, v as validatePosition, c as validateOffset, d as useModelToggleEmits, e as useTransition, f as useScrollTarget, g as useAnchor, h as useModelToggle, i as usePortal, r as removeClickOutside, s as setPosition, p as parsePosition, j as addClickOutside, m as closePortalMenus } from "./position-engine.bfb87100.js";
import { u as useCharacterStore, Q as QAvatar } from "./characters-store.048f4fbd.js";
import { u as useTick, e as useTimeout, g as getScrollTarget, h as scroll } from "./use-timeout.b0f1f358.js";
import { f as childHasFocus, R as Ripple } from "./Ripple.31e5d7c7.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { getScrollTarget: getScrollTarget2, setVerticalScrollPosition } = scroll;
    ...
    const editOverlay = ref(null);
    const editOpenBtn = ref(null);
    ...
    function toggleEditCharacter(clickEvt) {
      ...
      if (editingCharacter.value) {
        ...
        const scrollTarget = getScrollTarget2(overlayContainer.value);
      ...
      editOverlay.value.$el.style.setProperty("transition", void 0);
      editOverlay.value.$el.style.setProperty("--x", animX + "px");
      editOverlay.value.$el.style.setProperty("--y", animY + "px");
    ...
    store.restoration.then(() => {
      updateTokenSelectionFromCurrentCharacter();
    });
    watch(currentCharacter, () => {
      updateTokenSelectionFromCurrentCharacter();
    });
    function updateTokenSelectionFromCurrentCharacter() {
      var _a;
      const charToken = toRaw((_a = currentCharacter == null ? void 0 : currentCharacter.value) == null ? void 0 : _a.associatedToken);
      if (!charToken)
        return;
    ...
    const selectedToken = computed({
      get: () => {
        var _a, _b, _c;
        return (_c = (_b = (_a = currentCharacter == null ? void 0 : currentCharacter.value) == null ? void 0 : _a.associatedToken) == null ? void 0 : _b.id) != null ? _c : "";
      },
      set: (newId) => {
    ...
    async function queryTokens() {
      ...
      const s = sleep(500);
      const tokens = await bexSendBridged("dom", "query-tokens", {}, 2e3).then((data) => data.tokens).catch(() => {
      });
      if (!tokens) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(QPage, {
        ...
        default: withCtx(() => [
          createVNode(QItem, { class: "text-h4 header-item" }, {
            default: withCtx(() => [
          ...
          createBaseVNode("div", {
            ref_key: "overlayContainer",
            ref: overlayContainer,
            class: "character-content-wrapper q-mt-md"
          }, [
            createVNode(QList, {
              ref_key: "statsOverview",
              ref: statsOverview,
              ...
              default: withCtx(() => [
                ...
                createVNode(QItem, {
                  ...
                  default: withCtx(() => [
                    createVNode(QInput, {
                      ...
                      "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => talentSearch.value = $event),
                      debounce: "200",
                      clearable: "",
                      autofocus: "",
                      placeholder: "Suche",
                      ...
                      onClear: _cache[1] || (_cache[1] = ($event) => talentSearch.value = "")
                    }, null, 8, ["modelValue"])
                  ]),
                  _: 1
                }),
                  ...
                  default: withCtx(() => {
                    ...
                    return [
                      createVNode(QItem, {
                        ...
                        onClick: _cache[2] || (_cache[2] = ($event) => expandedAttributes.value = !expandedAttributes.value)
                      }, {
                        default: withCtx(() => [
                ...
                createVNode(QItem, {
                  key: "show_inactive",
                  clickable: "",
                  onClick: _cache[4] || (_cache[4] = ($event) => showInactiveTalents.value = !showInactiveTalents.value)
                }, {
                  default: withCtx(() => [
                    createVNode(QItemSection, { side: "" }, {
                      default: withCtx(() => [
                        createVNode(QToggle, {
                          ...
                          "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => showInactiveTalents.value = $event),
            ...
            unref(currentCharacter) ? (openBlock(), createBlock(QList, {
              key: 0,
              ref_key: "editOverlay",
              ref: editOverlay,
              ...
              default: withCtx(() => [
                    ...
                    createVNode(QItemSection, null, {
                      default: withCtx(() => [
                        createVNode(QInput, {
                          ...
                          "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => unref(currentCharacter).generalData.name = $event),
                          debounce: "200",
                          autofocus: "",
                          label: "Name",
                          outlined: "",
                          ...
                          onClear: _cache[6] || (_cache[6] = ($event) => unref(currentCharacter).generalData.name = characterNameBackup.value),
                ...
                createVNode(QItemLabel, { header: "" }, {
                  default: withCtx(() => [
                    createTextVNode(" Verkn\xFCpftes Token ")
                  ]),
                  _: 1
                }),
                createVNode(TransitionGroup, { name: "list" }, {
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(Fragment, null, renderList(availableTokens.value, (t) => {
                      return withDirectives((openBlock(), createBlock(QItem, {
                        key: t.id,
                        tag: "label",
                        class: "rounded-borders",
                        onClick: withModifiers(($event) => onTokenItemClick(t.id), ["prevent"])
                      }, {
                        default: withCtx(() => [
                          createVNode(QItemSection, { avatar: "" }, {
                            default: withCtx(() => [
                              createVNode(QAvatar, {
                                icon: t.avatar ? void 0 : "sym_r_question_mark",
                                color: "primary",
                                "text-color": "white"
                              }, {
                                default: withCtx(() => [
                                  t.avatar ? (openBlock(), createBlock(QImg, {
                                    key: 0,
                                    src: t.avatar
                          ...
                          createVNode(QItemSection, null, {
                            default: withCtx(() => [
                              createTextVNode(toDisplayString(t.name || "Kein verkn\xFCpftes Token"), 1)
                            ]),
                            _: 2
                          }, 1024),
                          availableTokens.value.length > 1 ? (openBlock(), createBlock(QItemSection, {
                            key: 0,
                            side: ""
                          }, {
                            default: withCtx(() => [
                              createVNode(QRadio, {
                                modelValue: unref(selectedToken),
                                "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => isRef(selectedToken) ? selectedToken.value = $event : null),
                                val: t.id,
                                size: "42px"
                    ...
                    roll20Unavailable.value ? (openBlock(), createBlock(QItem, { key: "connection_error" }, {
                      default: withCtx(() => [
                        createVNode(QItemSection, { avatar: "" }, {
                          default: withCtx(() => [
                            createVNode(QAvatar, null, {
                        ...
                        createVNode(QItemSection, null, {
                          default: withCtx(() => [
                            createVNode(QItemLabel, null, {
                              default: withCtx(() => [
                                createTextVNode(" Roll20 ist nicht erreichbar ")
                              ]),
                              _: 1
                            }),
                            createVNode(QItemLabel, { caption: "" }, {
                              default: withCtx(() => [
                                createTextVNode(" Bitte \xF6ffne einen Tab mit der Kampagne aus der Du einen Charakter verkn\xFCpfen willst, und versuche es erneut. ")
                              ]),
                              _: 1
                            })
                          ]),
                ...
                createVNode(QItemLabel, { header: "" }, {
                  default: withCtx(() => [
                    createTextVNode(" Sonstiges ")
                  ]),
                  _: 1
                }),
                withDirectives((openBlock(), createBlock(QItem, { tag: "label" }, {
                  default: withCtx(() => [
                    createVNode(QItemSection, { avatar: "" }, {
                      default: withCtx(() => [
                        createVNode(QAvatar, {
                    ...
                    createVNode(QItemSection, null, {
                      default: withCtx(() => [
                        createTextVNode(" Charakter l\xF6schen ")
                      ]),
                      _: 1
                    }),
                    createVNode(QItemSection, { side: "" }, {
                      default: withCtx(() => [
                        createVNode(QCheckbox, {
                          modelValue: deleteEnabled.value,
                          "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => deleteEnabled.value = $event),
                          color: "grey-8"
                        }, null, 8, ["modelValue"])
                      ]),
                      _: 1
                    ...
                    createVNode(QItemSection, { class: "content-center" }, {
                      default: withCtx(() => [
                        createVNode(QBtn, {
                          ...
                          flat: "",
                          rounded: "",
                          label: "L\xF6schen best\xE4tigen",
                          style: normalizeStyle(deleteEnabled.value ? "" : "scale: 0.9; opacity: 0; pointer-events: none;"),
          ...
          createBaseVNode("div", {
            class: "sticky-fab",
            style: normalizeStyle(editingCharacter.value ? "scale: 0.9; opacity: 0; pointer-events: none;" : "")
          }, [
            createVNode(QFab, {
              ref_key: "fab",
              ref: fab,
            ...
            createBaseVNode("input", {
              ...
              accept: ".xml",
              style: { "display": "none" },
              onInput: _cache[9] || (_cache[9] = (evt) => parseImportedFile(evt.target.files[0]))
            }, null, 544)
          ], 4)
        ]),
        _: 1
