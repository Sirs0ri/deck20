...
import { r as ref, i as isRuntimeSsrPreHydration, o as onMounted, a as onBeforeUnmount, n as noop, b as nextTick, h, g as getCurrentInstance, l as listenOpts, w as watch, c as client, d as leftClick, e as addEvt, p as preventDraggable, f as prevent, s as stop, j as position, k as cleanEvt, m as stopAndPrevent, q as computed, t as debounce, u as onDeactivated, v as onActivated, x as withDirectives, y as emptyRenderFn, z as inject, A as layoutKey, B as provide, C as pageContainerKey, D as tabsKey, E as isKeyCode, F as shouldIgnoreKey, G as isDeepEqual, H as getUid, I as reactive, J as onUnmounted, K as openBlock, L as createBlock, M as withCtx, N as createVNode, O as createBaseVNode, P as createElementBlock, Q as renderList, R as unref, S as Fragment, T as resolveComponent, U as normalizeClass } from "./index.b0068bd8.js";
import { c as createComponent, a as createDirective, h as hMergeSlot, b as hSlot } from "./render.a8eadc37.js";
import { g as getScrollTarget, a as getVerticalScrollPosition, b as getHorizontalScrollPosition, c as clearSelection, s as setVerticalScrollPosition, d as setHorizontalScrollPosition, u as useTick, e as useTimeout, f as getScrollbarWidth } from "./use-timeout.b0f1f358.js";
import { g as getModifierDirections, s as shouldStart } from "./touch.70a9dd44.js";
import { R as Ripple, u as useRouterLinkProps, a as useRouterLink } from "./Ripple.31e5d7c7.js";
import { Q as QIcon } from "./QIcon.b3f3bd12.js";
...
function useTab(props, slots, emit, routeData) {
  ...
  function onClick(e, keyboard) {
    ...
    if (routeData.hasRouterLink.value === true) {
      const go = (opts = {}) => {
        let hardError;
        const reqId = opts.to === void 0 || isDeepEqual(opts.to, props.to) === true ? $tabs.avoidRouteWatcher = getUid() : null;
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    bexSend("query-server-status").then(({ data }) => {
      if (data == null || data.unavailable)
        serverAvailable.value = false;
      else
        serverAvailable.value = true;
      serverActive.value = (data == null ? void 0 : data.active) || false;
    });
