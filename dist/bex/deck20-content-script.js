(() => {
  ...
  // src-bex/deck20-content-script.js
  ...
  var deck20_content_script_default = (0, import_wrappers.bexContent)((bridge2) => {
    log("active", Date.now());
  ...
  // .quasar/bex/entry-content-script-deck20-content-script.js
  ...
  deck20_content_script_default(bridge);
})();
