              ...
              createVNode(TransitionGroup, { name: "list" }, {
                default: withCtx(() => {
                  ...
                  return [
                    ...
                    expandedAttributes.value ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList((_a = unref(currentCharacter)) == null ? void 0 : _a.attributes, (attr) => {
                            ...
                            default: withCtx(() => [
                              ...
                              createVNode(QItemSection, { class: "col" }, {
                                default: withCtx(() => {
                                  var _a2, _b;
                                  return [
                                    createTextVNode(toDisplayString(talent.name) + toDisplayString(((_a2 = talent.specializations) == null ? void 0 : _a2.length) ? "*" : "") + toDisplayString(talent.attributes ? ` (${(_b = talent.attributes) == null ? void 0 : _b.join("/")})` : "") + ": ", 1)
                                  ];
                                }),
                                _: 2
                              }, 1024),
                              ...
                              createVNode(QItemSection, { side: "" }, {
                                default: withCtx(() => [
                                  talent.extraRolls ? (openBlock(), createBlock(QBtn, {
                                    key: 0,
                                    dense: "",
                                    flat: "",
                                    round: "",
                                                ...
                                                default: withCtx(() => [
                                                  createVNode(QItemSection, null, {
                                                    default: withCtx(() => {
                                                      var _a2;
                                                      return [
                                                        createTextVNode(toDisplayString(talent.name) + ": " + toDisplayString((_a2 = talent.value) != null ? _a2 : "n.a."), 1)
                                                      ];
                                                    }),
                                                    _: 2
                                                  }, 1024)
                                              ...
                                              (openBlock(true), createElementBlock(Fragment, null, renderList(talent.extraRolls, (value, extraRoll) => {
                                                return openBlock(), createBlock(QItem, {
                                                  ...
                                                  default: withCtx(() => [
                                                    createVNode(QItemSection, null, {
                                                      default: withCtx(() => [
                                                        createTextVNode(toDisplayString(extraRoll) + ": " + toDisplayString(value != null ? value : "n.a."), 1)
                                                      ]),
                                                      _: 2
                                                    }, 1024)
                                                  ]),
